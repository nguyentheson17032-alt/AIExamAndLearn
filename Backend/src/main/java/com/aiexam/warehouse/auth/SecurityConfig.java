...
import com.aiexam.warehouse.user.WarehouseUserDetailsService;
...
public class SecurityConfig {
    ...
    @Bean
    AuthenticationProvider authenticationProvider(WarehouseUserDetailsService users, PasswordEncoder encoder) {
